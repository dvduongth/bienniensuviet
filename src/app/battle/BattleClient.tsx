  ...
  if (phase === 'ready') {
    return (
      <div className="max-w-3xl mx-auto px-4 py-10 text-center">
        <h1 className="text-3xl font-bold text-red-800 mb-4">Đấu nhanh</h1>
        <p className="text-stone-600 mb-2">Trả lời 10 câu hỏi trong 60 giây!</p>
        <p className="text-stone-500 text-sm mb-6">
          Chủ đề tuần này: <strong>Văn Lang – Âu Lạc</strong>
        </p>
        <button
          onClick={startBattle}
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <span className="text-sm text-amber-700 font-semibold">{score} điểm</span>
      </div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-red-800 mb-2">Kết quả</h2>
        <p className="text-4xl font-bold text-amber-600">{score} điểm</p>
        <p className="text-stone-600 mt-2">
          Đúng {correctCount}/{answers.length} câu | Tuần {weekKey}
        </p>
      </div>

      {/* Wrong answers review */}
      <div className="space-y-3 mb-6">
        <h3 className="font-semibold text-stone-700">Các câu sai:</h3>
        {answers.map((a, i) => {
          ...
          return (
            <div key={i} className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <p className="text-red-600 text-sm">
                Bạn chọn: {a.selectedIndex >= 0 ? q.options[a.selectedIndex] : '(hết giờ)'}
              </p>
        ...
        {answers.every((a) => a.correct) && (
          <p className="text-green-700 font-semibold">Tuyệt vời! Bạn trả lời đúng hết!</p>
        )}
      </div>
